...
from joeynmt.rl_training import train as rl_train
from joeynmt.training import train
from joeynmt.prediction import test
from joeynmt.prediction import rl_test
...
def main():
    ...
    ap.add_argument("mode", choices=["train", "rl_train", "test", "rl_test", "translate"],
    ...
    ap.add_argument("--output_path", type=str,
                    help="path for saving translation/RL test output")
    ...
    if args.mode == "rl_train":
        rl_train(cfg_file=args.config_path)
    elif args.mode == "test":
        ...
        rl_test(cfg_file=args.config_path, ckpt=args.ckpt,
